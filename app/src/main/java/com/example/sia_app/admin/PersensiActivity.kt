...
class PersensiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_persensi)
    ...
    private fun getAllJadwal(){
        ...
        db.collection("jadwal").get().addOnSuccessListener { result ->
            if(result.isEmpty){
                ...
                val jadwalAdapter = JadwalAdapter(this, listJadwal, listMK, listDosen, listKrsMhs, false, true)
